...
•	`https://<worker-server>:55000/security/user/authenticate/run_as` – Specifies the run_as endpoint URL. The placeholder <worker-server> should be replaced with the actual hostname or IP address of the Wazuh worker server.
